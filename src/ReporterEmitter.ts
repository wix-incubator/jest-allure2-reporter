...
export type ReporterEmitter = EventEmitter & {
  ...
  on(event: 'runStart', listener: (event: RunStartEvent) => void): ReporterEmitter;
  on(event: 'testFileStart', listener: (event: TestFileStartEvent) => void): ReporterEmitter;
  on(event: 'testCaseResult', listener: (event: TestCaseResultEvent) => void): ReporterEmitter;
  on(event: 'testFileResult', listener: (event: TestFileResultEvent) => void): ReporterEmitter;
  on(event: 'runComplete', listener: (event: RunCompleteEvent) => void): ReporterEmitter;
};
