...
import { type GitHubEnvironment, GitHubInfoProvider } from './GitHubInfoProvider';

describe('GitHubInfoProvider', () => {
  const apiUrl = 'https://api.github.com/repos/owner/repo/actions/runs/123/attempts/1/jobs';
