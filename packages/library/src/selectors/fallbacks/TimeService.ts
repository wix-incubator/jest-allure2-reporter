...
export class TimeService {
  ...
  constructor(
    ...
    this._emitter.on('testFileStart', (event) =>
      this._onTestFileStart(event.test),
    );
    this._emitter.on('testFileResult', (event) =>
      this._onTestFileResult(event.test),
    );
    this._emitter.on('testCaseResult', (event) =>
